...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        ...
        <div class="dropdown">
            <button class="btn btn-dark dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Welcome, <?php echo " ".$_SESSION["my_user"]." " ?> <img id="my_icon" src="../images/user1.png">
            </button>
